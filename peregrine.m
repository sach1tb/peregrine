...
prompt={'Foreground is light (0=no, 1=yes):',...
        'Frame rate:', ...
        'Approx. number of targets on screen at any time:', ...
        'Blurring big blobs (width, height, sigma, extension):', ...
        'Blurring blob size (pixels):', ...
        'Tracker type (0=kf+gnn, 1=kf+gnn+nn, 2=pf+gnn):', ...
        'Record frames during verification (0=no, 1=yes)', ...
        'length, breadth of roi in cm', ...
        'shape of roi (0=square, 1=circle)', ...
        'Split occlusions (1=yes, 0=no. slow and only if similar targets present)', ...
        'Shape tracking (1=yes, 0=no. fish only)', ...
        'Background build (any number less than 1=running, 0=highest intensity)'};
name='Preferences';
numlines=1;
